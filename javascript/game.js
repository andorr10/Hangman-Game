...
document.onkeyup = function(event) {
        ...
        if (magicWord.indexOf(userGuess) > -1) {
            ...
            if (underScores.indexOf("_") === -1) {
                totalWins++;
                document.getElementById("totalWins").innerHTML = "Total Wins: " + totalWins;
                alert("Congrats! You have won the Game of Thrones.  The word was: " + magicWord);
                reset();
                return;
            }
        } else {
            ...
            if (guessesLeft < 1) {
                totalLosses++;
                document.getElementById("totalLosses").innerHTML = "Total Losses: " + totalLosses;
  //              alert("you lost the game!"Total Losses: "+ totalLosses;
                  alert("When the snows fall and the white winds blow, the lone wolf dies but the pack survives. Play again?");
                reset();
                return;
            }
        }
